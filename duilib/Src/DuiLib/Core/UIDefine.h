...
#define DUI_MSGTYPE_CREATEACTIVEX_FAILED   (_T("createactivexfailed"))
...
#define DUI_MSGTYPE_ENTERTAB				(_T("entertab"))
#define DUI_MSGTYPE_POSCHANGED				(_T("poschanged"))
	//////////////////////////////////////////////////////////////////////////

#define  DUI_MSGTYPE_EDIT_KILLFOCSE			(_T("editkillfocuse"))
...
#define  DUI_CTR_WKE_WEBKIT						 (_T("wkeWebKit"))
	///
	//////////////END控件名称宏定义//////////////////////////////////////////////////
