...
CComboUI::CComboUI() : m_pWindow(NULL), m_iCurSel(-1), m_uButtonState(0)
{
    ...
    m_ListInfo.dwSelectedBkColor = 0/*0xFFF2F2F2*//*0xFFC1E3FF*/;
    m_ListInfo.dwHotTextColor = 0xFF000000;
    m_ListInfo.dwHotBkColor = 0/*0xFFF2F2F2*//*0xFFE9F5FF*/;
...
bool CComboUI::SelectItem(int iIndex,bool bNotify, bool bTakeFocus)
{
