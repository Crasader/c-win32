...
public:
	...
	static bool SetLangXml(LPCTSTR lpsLangXml, LPCTSTR lpsLangPath);
	static bool SetDefLang(LPCTSTR lpsLang);
	static bool SwitchLang(LPCTSTR lpsLang, LPCTSTR lpsLangXml = NULL);
	static bool GetLangText(LPCTSTR lpsLangID, CDuiString& strText);
	static void OnSwitchLang(CControlUI* lpItem);
	...
	void ShowToolTip(LPCTSTR lpszText,RECT rc);
	void HideToolTip();
private:
...
private:
	...
	static CDuiLangManager s_langMgr;
